...
export default function AnamikaLookbookPage() {
  return <LookbookIntro name="Anamika" number="02" description="A movement-led editorial chapter balancing deep tones, sculpted silhouettes, and a quiet sense of theatre." url="https://lookbookmaker.onrender.com/catalog/anamika-lookbook?page=1" />;
}
