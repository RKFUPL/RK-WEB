...
export default function HastakalaLookbookPage() {
  return <LookbookIntro name="Hastakala" number="01" description="A craft-led wedding edit where hand-finished surfaces, precise detail, and heirloom references take centre stage." url="https://heyzine.com/flip-book/2a2d77de0e.html" />;
}
