...
export default function EspirituLibreLookbookPage() {
  return <LookbookIntro name="Espiritu Libre" number="05" description="An expressive runway chapter shaped by liberated movement, fluid drape, and the confidence of modern Indian couture." url="https://heyzine.com/flip-book/381fdec685.html" />;
}
