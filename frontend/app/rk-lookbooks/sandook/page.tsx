...
export default function SandookLookbookPage() {
  return <LookbookIntro name="SANDOOK" number="04" description="A treasured visual archive of soft occasion dressing, heirloom moods, and stories designed to be carried forward." url="https://lookbookmaker.onrender.com/catalog/sandook" />;
}
