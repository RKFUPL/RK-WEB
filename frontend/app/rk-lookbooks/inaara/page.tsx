...
export default function InaaraLookbookPage() {
  return <LookbookIntro name="INAARA" number="06" description="A luminous celebration of floral colour, fluid lines, and couture pieces created for moments of radiance." url="https://lookbookmaker.onrender.com/catalog/inaara" />;
}
