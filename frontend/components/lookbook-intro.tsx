  ...
  return (
    <main className="lookbook-intro relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-6 text-center text-white">
      ...
      <div className="relative z-10 flex w-full max-w-6xl flex-col items-center">
        ...
        <h1 style={{ opacity: 0, transform: 'translateY(24px)' }} className="intro-title mt-8 max-w-6xl font-aakaar text-[clamp(3.2rem,9vw,8.5rem)] leading-[0.9] tracking-[0.025em] text-white md:mt-10">
